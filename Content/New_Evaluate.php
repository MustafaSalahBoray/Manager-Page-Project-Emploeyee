		...
		<div class="card-body" style="width:1400px;margin:auto; margin-right: 50px;">
			<form action="" id="manage_evaluation" method="POST">
				...
				<div class="row">
					<div class="col-md-6 border-right">
							...
							<label for="" class="control-label">Manager</label>';
                                    $show=$db->prepare("SELECT * FROM manager WHERE manger_id=:ikey");
								$show->bindparam("ikey",$key);
				...
				if (isset($_POST['submit'])) {
				   $INSERT=$db->prepare("INSERT INTO evaluation (Task,Name,Efficiency,Timeliness,Quality,Accuracy,Remarks,Evalouter) VALUES (:Task,:Name,:Efficiency,:Timeliness,:Quality,:Accuracy,:Remarks,:Evalouter)");
